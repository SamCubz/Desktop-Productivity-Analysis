...
from mouse_listening2 import MouseListening
import threading
import pandas as pd
import numpy as np
...
class Base:
    ...
    def startDataCollection(self):
        ...
        self.processing = Processing(self.mouseDF, self.keyboardDF,  self.sessionNumber, timeOfDay, sessionTime= time.time())
        ...
        self.root.after(10000, self.gettingData)
    ...
    def gettingData(self):
        """Purely the data collection for the machine learning model"""

        #this will repeat data collection every 60 seconds
        ...
        if self.inSession[0]:
            self.root.after(5000,self.gettingData)

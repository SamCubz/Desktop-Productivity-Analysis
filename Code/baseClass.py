...
class Base:
    ...
    def startDataCollection(self):
        ...
        self.processing = Processing(self.mouseDF, self.keyboardDF,  self.sessionNumber, timeOfDay, sessionTime= time.time(), completeSessionStart= self.sessionStart, model = self.model, collectionStatus= self.collectionStatus)
    ...
    def endDataCollection(self):
        ...
        self.processing.mainStorageFunction()
        self.processing.inactivityDuration()
